 ...
 */
export async function createHtmlChangelog({ options, logger }: IContext, version: string, useFaIcons = false, includeStyling = false, inputFile?: string)
{
    let changeLog = "",
...
function getHtmlFormattedMessage(message: string, isHtmlMsg = false)
{
