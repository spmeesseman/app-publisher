 ...
 */
export async function getTagHead(tagName, execaOpts) {
  try {
 ...
 */
export async function getTags(execaOpts) {
 ...
 */
export async function isRefInHistory(ref, execaOpts) {
  try {
 ...
 * @param {Object} [execaOpts] Options to pass to `execa`.
 */
export async function fetch(repositoryUrl, execaOpts) {
  try {
 ...
 */
export function getGitHead(execaOpts) {
 ...
 */
export async function repoUrl(execaOpts) {
  try {
 ...
 */
export async function isGitRepo(execaOpts) {
  try {
 ...
 */
export async function verifyAuth(repositoryUrl, branch, execaOpts) {
  try {
 ...
 */
export async function tag(tagName, execaOpts) {
 ...
 */
export async function push(repositoryUrl, execaOpts) {
 ...
 */
export async function verifyTagName(tagName, execaOpts) {
  try {
 ...
 */
export async function isBranchUpToDate(branch, execaOpts) {
